...
public sealed partial class D3D12GraphicsDevice {
    ...
    public D3D12GraphicsDevice(bool validation, Window window, Format depthStencilFormat = Format.D32_Float) {
        ...
        if (_depthStencilFormat != Format.Unknown) {
            ...
            Device.CreateDepthStencilView(_depthStencilTexture, dsViewDesc,
    ...
    public void Dispose() {
        ...
        if (refCount > 0) {
            System.Diagnostics.Debug.WriteLine(
                $"Direct3D11: There are {refCount} unreleased references left on the device");
    ...
    public bool DrawFrame(Action<int, int> draw, [CallerMemberName] string? frameName = null) {
        ...
        CpuDescriptorHandle rtvDescriptor = new(_rtvDescriptorHeap.GetCPUDescriptorHandleForHeapStart(),
            _backbufferIndex, _rtvDescriptorSize);
        CpuDescriptorHandle? dsvDescriptor =
            _dsvDescriptorHeap != null ? _dsvDescriptorHeap.GetCPUDescriptorHandleForHeapStart() : null;
        ...
        _commandList.IASetVertexBuffers(0,
            new VertexBufferView(_vertexBuffer.GPUVirtualAddress, vertexBufferSize, stride));
